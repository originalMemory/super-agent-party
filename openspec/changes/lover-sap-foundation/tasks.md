...
- [x] 1.1 README：固定 **USER 独立**；**IDENTITY.md** 与 **SOUL.md** **必须分文件、不合并**；**AGENTS** 可选；记忆仅 FTS（**`MEMORY.md`** + **`memory/YYYY/MM/YYYY-MM-DD.md`** 日记，对用户可见）；bootstrap **加载顺序**（见根 `README.md` / `README_ZH.md` 入口与 **`docs/LOVER_SSOT.md`**）
...
- [ ] 2.2 索引白名单：**`MEMORY.md`** + **`memory/YYYY/MM/*.md`**（按日日记）；排除 USER/IDENTITY/SOUL/AGENTS；监视日记目录变更以增量索引
...
- [ ] 6.1 README：上游合并策略
- [ ] 6.2 lover 定位、SSOT、FTS 仅记忆、可见日记路径 **`memory/YYYY/MM/`**、更名 super-agent-lover

## 7. 冒烟

- [ ] 7.1 连续两轮：bootstrap **无重复膨胀**；FTS 仅记忆命中
- [ ] 7.2 专有名词进 MEMORY 或 **当日日记文件** → FTS 命中；simple 失败降级
- [ ] 7.3 归档与重置
