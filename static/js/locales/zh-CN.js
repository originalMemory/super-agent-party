window.lang_zhCN = {
        ...
        'archiveFilePathLabel': '目标文件路径',
        'archiveFilePathPlaceholder': 'lover/memory/YYYY/MM/YYYY-MM-DD-work-slug.md',
        'archiveFilePathHint': '摘要将落盘到此路径，下次 sync 后可被 FTS 召回',
        'devArchiveQuickSaveLabel': '快速保存（跳过弹窗）',
        'devArchiveQuickSaveHint': '开启后归档时自动使用元信息摘要，不弹窗确认',
        'confirmArchive': '确认归档',
