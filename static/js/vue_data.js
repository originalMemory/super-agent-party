...
let vue_data = {
  ...
  "mcpServers": {
    ...
    newBehavior:{
      ...
      skipIfRecentlyActive: false,
      skipWindowMinutes: 30,
      noActionDetection: false,
      messageKind: "chat",
      presetId: null,
    },
    allBriefly:false,
    ...
    activeLoverFileTab: 'soul',
    loverFiles: { soul: '', userProfile: '', memoryNotes: '' },
    loverFileLoading: { soul: false, userProfile: false, memoryNotes: false },
    loverFilesLoaded: false,
    activeMCPTab: 'config',
    activeCLITab: 'config',
    quickCreatePrompt: '',
