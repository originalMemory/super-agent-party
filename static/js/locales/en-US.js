window.lang_enUS = {
        ...
        'rename': 'Rename',
        'defaultConversationGroup': 'Main Group',
        'archiveConversationGroup': 'Archive',
        'newDevSession': 'New Dev Session',
        'devSessionTitle': 'Session Name',
        'devSessionTitlePlaceholder': 'Optional, auto-generated by default',
        'mainSession': 'Main',
        'resetMainSession': 'Reset Main Session',
        'resetMainSessionWarning': 'This will clear all messages in the main session. This action cannot be undone.',
        'mainSessionReset': 'Main session has been reset',
        'archiveMainSession': 'Archive Main Session',
        'archiveMainSessionWarning': 'This will snapshot the main session to the archive group and reset the original. This action cannot be undone.',
        'mainSessionArchived': 'Main session archived',
        'archive': 'Archive',
        'readOnly': 'Read-only',
        'create': 'Create',
        'archiveReadonlyTip': 'Archived session (read-only) — chat is disabled',
        'archiveSessionReadonly': 'Archived session, sending is disabled',
        'returnToMainSession': 'Return to Main',
        'archiveDevSession': 'Archive Dev Session',
        'archiveSummaryLabel': 'Session Summary',
        'archiveSummaryPlaceholder': 'Enter or let AI draft a summary for this dev session…',
        'aiDraftSummary': 'AI Draft',
        'draftingInProgress': 'Drafting…',
        'archiveDevSummaryToMainHint': 'Summary will be injected into the main conversation after archiving',
        'confirmArchive': 'Confirm Archive',
        'devSessionArchived': 'Dev session archived',
      ...
      'bodyPlaceholder': `Enter the body in JSON Schema format. For example:
{
    ...
    "required": ["name", "age"]
        ...
        'exportCharacterCard': 'Export Character Card JSON',
...
Key3`,
        ...
        'soul': 'Meta Principles',
        'soulPlaceholder': 'Core values, behavioral guidelines, tone, and proactiveness boundaries. Shared across all characters. Supports Markdown. Use {{user}} / {{char}} as placeholders',
        'soulHint': 'Values, tone, proactiveness boundaries — applies to all characters · lover/SOUL.md',
        'memoryNotes': 'Memory Notes',
        'memoryNotesPlaceholder': 'Manually curated long-term memory, injected every turn. Supports Markdown. Use {{user}} / {{char}} as placeholders',
        'memoryNotesHint': 'Hand-written long-term facts & agreements, injected every turn · lover/MEMORY.md',
        'heartbeatFile': 'Heartbeat Tasks',
        'heartbeatFileHint': 'Task memo injected during heartbeat checks, leave empty if not needed · lover/HEARTBEAT.md',
        'heartbeatFilePlaceholder': 'Task prompts for heartbeat, e.g.: remind me to drink water, check on my work status. Leave empty to use default heartbeat prompt',
        'userProfile': 'User Profile',
        'userProfileShared': 'Shared across all characters',
        'userProfilePlaceholder': 'Your name, preferences, important dates — shared across all characters. Supports Markdown. Use {{user}} / {{char}} as placeholders',
        'userProfileHint': 'Your name, preferences, important dates — all characters can see this · lover/USER.md',
        'memoryDirPath': 'Diary Tree Directory (FTS Index Root)',
        'memoryDirPathPlaceholder': 'Leave empty for default. Enter an absolute path; .md files under this directory will be full-text indexed',
        'memoryIndexSyncMinutes': 'FTS Index Sync Interval (minutes)',
        'ftsRebuildIndex': 'Rebuild Index',
        'ftsRebuildIndexHint': 'Manually trigger a full rebuild when the index is corrupted',
        'ftsRebuildSuccess': 'FTS index rebuilt successfully',
        'ftsRebuildFailed': 'Index rebuild failed',
        'userMemoryTab': 'User Profile & Memory',
        'avatar': 'Avatar',
        ...
        'desktopAwareness': 'Desktop Awareness',
        'desktopAwarenessHint': 'Periodically capture desktop screenshots and send to vision model to check if the user needs attention. Silent when no action is needed.',
        'desktopAwarenessInterval': 'Check Interval',
        'desktopAwarenessSkipWindow': 'Quiet Period',
        'desktopAwarenessSkipWindowHint': 'Skip awareness when any conversation in the main group was active within this window',
        'desktopAwarenessMinutesUnit': 'min',
        'desktopAwarenessTestNow': 'Test Now',
        'desktopAwarenessBusySending': 'Please wait until the current message finishes sending',
        'desktopAwarenessCheckFailed': 'Desktop awareness check failed',
        'desktopAwarenessSkippedQuiet': 'Skipped due to recent activity in the quiet period',
        'desktopAwarenessNoAction': 'Check complete: no proactive message needed',
        'desktopAwarenessActionDone': 'Proactive message added to the main conversation',
        'desktopAwarenessSeeMainConv': 'Switch to the main conversation to view the message',
        'desktopAwarenessNoMainConv': 'Main conversation not found',
        'heartbeat': 'Heartbeat',
        'kindDesktopAwareness': 'Desktop Awareness',
        'kindHeartbeat': 'Heartbeat',
        'kindDevSummary': 'Dev Summary',
        'kindArchiveSummary': 'Archive Summary',
        'heartbeatHint': 'Backend periodically triggers LLM, giving the character a chance to proactively speak or use tools during silence. Supports HEARTBEAT.md dynamic task file.',
        'heartbeatInterval': 'Heartbeat Interval',
        'heartbeatSkipWindow': 'Quiet Period',
        'heartbeatSkipWindowHint': 'Skip heartbeat when any conversation in the main group was active within this window',
        'heartbeatMinutesUnit': 'min',
        'heartbeatEnableTools': 'Allow Tool Calls',
        'heartbeatMaxToolRounds': 'Max Tool Rounds',
        'heartbeatMaxToolRoundsUnit': 'rounds',
        'heartbeatCustomPrompt': 'Custom Heartbeat Prompt',
        'heartbeatCustomPromptPlaceholder': 'Leave empty to use default prompt (supplement with HEARTBEAT.md for dynamic tasks)',
        'heartbeatTestNow': 'Test Now',
        'heartbeatBusySending': 'Please wait until the current message finishes sending',
        'heartbeatCheckFailed': 'Heartbeat check failed',
        'heartbeatSkippedQuiet': 'Skipped due to recent activity in the quiet period',
        'heartbeatNoAction': 'Heartbeat complete: no action needed',
        'heartbeatActionDone': 'Heartbeat triggered a proactive message',
        'heartbeatSeeMainConv': 'Switch to the main conversation to view the message',
        'yesterday': 'Yesterday',
