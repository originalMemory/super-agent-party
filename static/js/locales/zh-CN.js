window.lang_zhCN = {
        ...
        'rename': '重命名',
        'defaultConversationGroup': '主分组',
        'archiveConversationGroup': '归档分组',
        'newDevSession': '新建开发会话',
        'devSessionTitle': '会话名称',
        'devSessionTitlePlaceholder': '可选，默认自动生成',
        'mainSession': '主会话',
        'resetMainSession': '重置主会话',
        'resetMainSessionWarning': '重置后将清空当前主会话的所有消息记录，此操作不可撤销。',
        'mainSessionReset': '主会话已重置',
        'archiveMainSession': '归档主会话',
        'archiveMainSessionWarning': '将当前主会话快照到归档分组，原主会话清空重建。此操作不可撤销。',
        'mainSessionArchived': '主会话已归档',
        'archive': '归档',
        'readOnly': '只读',
        'create': '创建',
        'archiveReadonlyTip': '归档会话（只读）— 不可继续对话',
        'archiveSessionReadonly': '归档会话，不可发送消息',
        'returnToMainSession': '返回主会话',
        'archiveDevSession': '归档开发会话',
        'archiveSummaryLabel': '会话摘要',
        'archiveSummaryPlaceholder': '输入或由 AI 起草该开发会话的摘要…',
        'aiDraftSummary': 'AI 起草',
        'draftingInProgress': '正在起草…',
        'archiveDevSummaryToMainHint': '归档后摘要将自动注入主会话，便于后续回顾',
        'confirmArchive': '确认归档',
        'devSessionArchived': '开发会话已归档',
        'archiveFailed': '归档失败',
        'moveToGroup': '移至项目',
        'moreActions': '更多操作',
      ...
      'bodyPlaceholder': `请输入请求体，使用JSON Schema格式。例如：
{
    ...
    "required": ["name", "age"]
        ...
        'exportCharacterCard': '导出角色卡 JSON',
        'noResults': '暂无结果',
...
key3`,
        ...
        'soul': '元层原则',
        'soulPlaceholder': '核心价值观、行为准则、语调总纲和主动性边界，所有角色共享。支持 Markdown，可用 {{user}} / {{char}} 占位符',
        'soulHint': '价值观、语调总纲、主动性边界，对所有角色生效 · lover/SOUL.md',
        'memoryNotes': '记忆笔记',
        'memoryNotesPlaceholder': '手工维护的结构化长期记忆，每轮对话常驻注入。支持 Markdown，可用 {{user}} / {{char}} 占位符',
        'memoryNotesHint': '手写长期事实与约定，每轮常驻注入 · lover/MEMORY.md',
        'heartbeatFile': '心跳任务',
        'heartbeatFileHint': '心跳触发时注入的任务备忘，可留空 · lover/HEARTBEAT.md',
        'heartbeatFilePlaceholder': '心跳触发时的任务提示，例如：每天提醒我喝水、关注我的工作状态。留空则仅使用默认心跳 prompt',
        'userProfile': '用户档案',
        'userProfileShared': '所有角色共享',
        'userProfilePlaceholder': '你的姓名、偏好、重要日期等，所有角色共享。支持 Markdown，可用 {{user}} / {{char}} 占位符',
        'userProfileHint': '你的姓名、偏好、重要日期，所有角色可感知 · lover/USER.md',
        'memoryDirPath': '日记树目录（FTS 索引根目录）',
        'memoryDirPathPlaceholder': '留空则使用默认目录。填写绝对路径，目录下的 .md 文件将被全文索引',
        'memoryIndexSyncMinutes': 'FTS 索引同步间隔（分钟）',
        'ftsRebuildIndex': '重建索引',
        'ftsRebuildIndexHint': '索引损坏时手动触发全量重建',
        'ftsRebuildSuccess': 'FTS 索引重建完成',
        'ftsRebuildFailed': '索引重建失败',
        'userMemoryTab': '用户档案与记忆',
        'avatar': '头像',
        ...
        'desktopAwareness': '桌面主动感知',
        'desktopAwarenessHint': '定时截取桌面截图发送给视觉模型，判断是否需要主动关心用户。不需要时静默记录，不打扰。',
        'desktopAwarenessInterval': '检查间隔',
        'desktopAwarenessSkipWindow': '免打扰窗口',
        'desktopAwarenessSkipWindowHint': '主分组内任意会话在此时间内有活动时，跳过本次感知',
        'desktopAwarenessMinutesUnit': '分钟',
        'desktopAwarenessTestNow': '立即测试',
        'desktopAwarenessBusySending': '正在发送消息，请稍后再试',
        'desktopAwarenessCheckFailed': '桌面感知检查失败',
        'desktopAwarenessSkippedQuiet': '免打扰窗口内有会话活动，已跳过本次感知',
        'desktopAwarenessNoAction': '检查完成：当前无需主动关心',
        'desktopAwarenessActionDone': '已写入主动关心消息',
        'desktopAwarenessSeeMainConv': '消息已写入主会话，请切换到主会话查看',
        'desktopAwarenessNoMainConv': '未找到主会话，无法写入消息',
        'heartbeat': '心跳机制',
        'kindDesktopAwareness': '桌面感知',
        'kindHeartbeat': '心跳',
        'kindDevSummary': '开发摘要',
        'kindArchiveSummary': '归档摘要',
        'heartbeatHint': '后端定时触发 LLM，让角色有机会在你沉默时主动说话或调用工具。支持 HEARTBEAT.md 动态任务文件。',
        'heartbeatInterval': '心跳间隔',
        'heartbeatSkipWindow': '免打扰窗口',
        'heartbeatSkipWindowHint': '主分组内任意会话在此时间内有活动时，跳过本次心跳',
        'heartbeatMinutesUnit': '分钟',
        'heartbeatEnableTools': '允许工具调用',
        'heartbeatMaxToolRounds': '最大工具轮数',
        'heartbeatMaxToolRoundsUnit': '轮',
        'heartbeatCustomPrompt': '自定义心跳 Prompt',
        'heartbeatCustomPromptPlaceholder': '留空则使用默认 Prompt（可在 HEARTBEAT.md 中补充动态任务）',
        'heartbeatTestNow': '立即测试',
        'heartbeatBusySending': '正在发送消息，请稍后再试',
        'heartbeatCheckFailed': '心跳检查失败',
        'heartbeatSkippedQuiet': '免打扰窗口内有会话活动，已跳过本次心跳',
        'heartbeatNoAction': '心跳检查完成：当前无需行动',
        'heartbeatActionDone': '心跳已触发主动消息',
        'heartbeatSeeMainConv': '消息已写入主会话，请切换查看',
        'yesterday': '昨天',
