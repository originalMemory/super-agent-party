...
Key3`,
        ...
        'soul': 'SOUL (Meta Principles)',
        'soulPlaceholder': 'Define the character\'s core values, behavioral guidelines, and meta-level constraints. Supports Markdown. Use {{user}} / {{char}} as placeholders',
        'memoryNotes': 'Memory Notes',
        'memoryNotesPlaceholder': 'Manually curated structured long-term memory, injected every turn. Supports Markdown. Use {{user}} / {{char}} as placeholders',
        'userProfile': 'User Profile',
        'userProfileShared': 'Shared across all characters',
        'userProfilePlaceholder': 'Basic info about the user, shared across all character cards. Supports Markdown. Use {{user}} / {{char}} as placeholders',
