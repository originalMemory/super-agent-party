...
key3`,
        ...
        'soul': '元层原则 (SOUL)',
        'soulPlaceholder': '定义角色的核心价值观、行为准则和元层约束，支持 Markdown 格式。使用 {{user}} / {{char}} 作为占位符',
        'memoryNotes': '记忆笔记',
        'memoryNotesPlaceholder': '手工维护的结构化长期记忆，每轮对话都会常驻注入。支持 Markdown 格式。使用 {{user}} / {{char}} 作为占位符',
        'userProfile': '用户档案',
        'userProfileShared': '所有角色共享',
        'userProfilePlaceholder': '关于用户的基本信息，所有角色卡共享。支持 Markdown 格式。使用 {{user}} / {{char}} 作为占位符',
