window.lang_enUS = {
        ...
        'archiveFilePathLabel': 'Target File Path',
        'archiveFilePathPlaceholder': 'lover/memory/YYYY/MM/YYYY-MM-DD-work-slug.md',
        'archiveFilePathHint': 'Summary will be saved here and picked up by FTS on next sync',
        'devArchiveQuickSaveLabel': 'Quick save (skip dialog)',
        'devArchiveQuickSaveHint': 'When enabled, archives with metadata-only summary without confirmation',
