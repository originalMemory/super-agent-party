...
let vue_data = {
  ...
  "mcpServers": {
    ...
    loverFiles: { soul: '', userProfile: '', memoryNotes: '', heartbeat: '' },
    loverFileLoading: { soul: false, userProfile: false, memoryNotes: false, heartbeat: false },
...
-d '{
  ...
  "messages": [
    ...
    desktopAwareness: {
      enabled: false,
      intervalMinutes: 60,
      skipWindowMinutes: 20,
    },
    heartbeat: {
      enabled: false,
      intervalMinutes: 30,
      skipWindowMinutes: 10,
      prompt: '',
      enableTools: true,
      maxToolRounds: 20,
    },
